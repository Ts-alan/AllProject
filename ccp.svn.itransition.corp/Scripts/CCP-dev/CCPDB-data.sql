...
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (1, N'Michael', N'Jordan', N'Jordan@example.com', 2, N'AF8aGzS0+IXeLdXPyaUX3KosGLeS2zqq4dbbznQkg1TZZAHGDG3Y1QZj/ULJawn5Aw==', 1233)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (2, N'Elvis', N'Presley', N'elvis@example.com', 2, N'AH/jXkXxpuoBgNF14aXxB0IIGaveNmHBBGlu8ysnCN2UZIx2ElEKIyjSOz636XEavg==', 777)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (3, N'Lebron', N'James', N'Lebron@example.com', 1, N'AF8aGzS0+IXeLdXPyaUX3KosGLeS2zqq4dbbznQkg1TZZAHGDG3Y1QZj/ULJawn5Aw==', 1231)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (4, N'Chuck', N'Norris', N'admin@example.com', 3, N'AEe4BPxE1vapJT6rh3XcjpGW2c494EOY4T12ohAbyFb1s+T6Miu+wbZNWeH/AnZL/w==', 222)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (5, N'Semen', N'Muhin', N'Semen@example.com', 1, N'ANqDbPFja930DWczuM9sG9tKiDlWVO9mEGxt0cey0sXfh5tL8uIqxwXQZ46G9bvVOw==', 231)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (6, N'Clark', N'Kent', N'superman@example.com', 1, N'AO8dP6kPRUSLMtNO9GQQGrnOJm1nnD7whv6QOIxSg8kvSlLLuMg/Uiri5wOz0mM2Kg==', 111)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (7, N'Kate', N'Black', N'kate.black@example.com', 2, N'AOoHbCQvIwJEa5Oc4XDaVO86vYushM//k3XAEkz3RrQ8i5OFnmC/n/aq83nyj3lQqw==', 123123)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (8, N'Tony', N'Stark', N'initiator@example.com', 1, N'AGJcTNE7lj63Ogyxe17iGPi6ayOGYZY3ZvxAlGyWp9ZeNZlbjLmG85ETYWgvsaGWAw==', 123123)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (9, N'Bruce', N'Bane', N'admin1@example.com', 3, N'AGTJJbk64Cwp37ee4R0Z8FAgHnLYE7Bcv4mvz5ApbCBeTlwdjJh6/Tw9lN0JT5COGw==', 87415)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (10, N'Luke', N'Skywalker', N'Low@example.com', 2, N'AEeXOvlOT08LrAgdge2E6h25uWFIwsGl05g+eIgIV5jHQpMgWCH8fDeQQfGOThqlzA==', 812144)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (11, N'Obi-Wan', N'Kenobi', N'Mid@example.com', 2, N'AA4KaSS4bffeuTcPQv7iuq0xluvO3JML7murxUrDwhbMIcctDPGh4xyjxz1FF+JsXA==', 893)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (12,  N'Dart', N'Wader', N'High@example.com', 2, N'ANTj8cI+2SN8vasnuz0ZNzXgPrBCS2S5/cP44VMRsbwPHfMC1EIx9v9EzyxX4fGc4A==', 829)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (13, N'Peter', N'Blake', N'InitiationForEverybody@example.com', 1, N'AL9aFV0tWMyfxwMsLKrJxPY+Fc8Jez3fJ6wvrkOoIMvo+6LeRSsDUrqdCpoYOr+XaQ==', 67390)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (14, N'Fedor', N'Ivanov', N'Fedor@example.com', 2, N'ANjU2bWe11Vu8yQ0hPgCOxohXefSwnlk8nZOE1sluvi/MfAxXEfJsxBDjKHw3nvEQA==', 78426)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (15, N'Mihail', N'Govrilov', N'Mihail.govrilov@example.com', 2, N'AGMtDxeV9lexUShbFChPej2cKQ/dQVRoY4soX7h8DbVQCxyOzT14ljUBcYfwtukx+A==', 123123)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (16, N'Artem', N'Petrov', N'petrov.a@example.com', 1, N'AFd+pLr+94bjLoR8lQqgaKuGRFaInoI/xmWnWnsKCoMRU1CdPRfUByXfK9Q7rBNnxg==', 784923)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (17, N'Allen', N'Iverson', N'salesforeverybody@example.com', 1, N'AKf2LJaDntEdv+XQRe2i18u+QXgNefdMO6e33ntEAQzvuaOmNixYhmCCTg5KRK1Kng==', 41656)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (18, N'Carl', N'Malone', N'carl@example.com', 1, N'ADoesBVHAm97EB3gqKoIaYyXSR2EPoZJx3Nt3HWoRtad2YmAUUC5GguitVXJ0k8kTA==', 6784841)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (19, N'Nate', N'Robinson', N'Fima@example.com', 1, N'AC1Dmc+2h1V9ZdO3YZJ3Tyua9+Ml/S4iXHTM7EHdEezv+l9YNeIwHcz2JasMHeeITg==', 7283902)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (24, N'Kevin', N'Love', N'initiator@example.com', 1, N'ADFuyE9pLlS6hOGcuXdieF2t2xuak3USDKXZ6unZOtOcZ+pfxdz4Z825cSOxzvfnJA==', 747222)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (25, N'Shawn', N'Marion', N'Shawn@example.com', 1, N'AJHyarwz5ukZskv6cSCxu3oFEgyeuPuUhxIpYnTXfvbS4S5kurldeJNraC2ZpL8JEA==', 1231348)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (26, N'Shaquil', N'Oneal', N'shaquil@example.com', 1, N'APXQW/yvETYn/ZFoKEC3gsAUezRfc4Vv0akuq1nmKJwAus+ZmY74sXCfIPOwbfAL5A==', 12312384)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (27, N'Donald', N'Duck', N'donald@example.com', 2, N'AOBYLMKD4gVRRAInQAkqMas8iAhXsu98G7RveInkV5ukKd6tpMWPHnyHEhc6Ti5C2g==', 756489)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (28, N'Mickey', N'Mouse', N'mickey@example.com', 3, N'AENp2Kgli/5gq/8Pk4zg0AdWEWZsUIKgVzHClp1Fw/nTlu7sVDl0ByVKiSqc0PAiLA==', 4371432)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (37, N'Egor', N'Smirnov', N'smirnov_egor@example.com', 1, N'ANYSTHdbbWgHzHbeTkRSEZwGsajVMbodbTIIsOgMc9TU3JDt9WanwwzxekT0WA0WKA==', 6789866)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (41, N'Blake', N'Griffin', N'blake_griffin@example.com', 1, N'AMC9msf0rGBc2j9VJrZbAvvdWufQ5aauqq0xK8UmHHM3vutkRtdLTr4GZsE6GuvVLw==', 92929)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (43, N'Nikita', N'Visocky', N'nikitos@example.com', 3, N'AI11cc7oaLGhLCOZmg0L7/FHrcJ/jBaCIAFEYyDncjmZP08fPPw5n1mDquSiThHG9Q==', 78945)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (44, N'Mihail', N'Potapov', N'potapov@example.com', 1, N'AMGGwMWDiL9nVqn3mGZbs9mm2tLyQImaU/xBrtOSQ9VEpr6gMyLTQ64oFIQh33RbNg==', 1234)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (45, N'Viktor', N'Kuznecov', N'kuznec@example.com', 2, N'AA6Kc4rXAXz96kdC9eqTTtiZ/JK1EhknGqsz8b/V1c4CLI50bMKDx4uSmLWCMSTPDg==', 1234)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (46, N'Petya', N'Medvedev', N'medved@example.com', 1, N'AJ2dkVmufNZM7qsjldiV9PfinteNS4rqlVpYx9LD7lofoh+LJOjlXZr5g1qPK98iCg==', 2)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (47, N'Spider', N'Man', N'spiderman@example.com', 1, N'AGpI9SsPKDy4wbcFustQaVElwr7cX7GL5Pskb9AT8K8sl8OgN/4BFbpbkjGHA2tRJw==', 1)
GO
INSERT [dbo].[User] ([UserId], [FirstName], [LastName], [Email], [RoleId], [PasswordHash], [InternalUserId]) VALUES (48, N'Kurt', N'Cobain', N'cobain@example.com', 1, N'AFYZe5awWJDMSBso9+vSi5psLe4tNNTBj/gVq4OZeh2VzJgZxjygctfJIBTGhpPKrQ==', 1)
GO
