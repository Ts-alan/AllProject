<%@Page AutoEventWireup="true"  Language="C#" MasterPageFile="~/forms/Организация/Организация.master" %>
...
<script runat="server" >
    public void Кнопка8_Click(object sender, EventArgs e)
    {
        Response.Redirect("/forms/договоры/договоры");
    }

    //========== EVENT FUNCTION ============
    public void Кнопка6_Click(object sender, EventArgs e)
    {
        Response.Redirect("/");
    }

    //========== EVENT FUNCTION ============
    public void Кнопка5_Click(object sender, EventArgs e)
    {
        //TODO: Add your code here
    }

    //========== EVENT FUNCTION ============
    public void Кнопка4_Click(object sender, EventArgs e)
    {
