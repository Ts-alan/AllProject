IF EXISTS (SELECT [ID] FROM dbo.sysobjects WHERE [ID] = OBJECT_ID(N'[dbo].[PoliciesGroups]')
					   AND OBJECTPROPERTY(id, N'IsTable') = 1)
DROP TABLE [dbo].[PoliciesGroups]
GO

IF EXISTS (SELECT [ID] FROM dbo.sysobjects WHERE [ID] = OBJECT_ID(N'[dbo].[Groups]')
					   AND OBJECTPROPERTY(id, N'IsTable') = 1)
DROP TABLE [dbo].[Groups]
GO

IF EXISTS (SELECT [ID] FROM dbo.sysobjects WHERE [ID] = OBJECT_ID(N'[dbo].[GroupTypes]')
					   AND OBJECTPROPERTY(id, N'IsTable') = 1)
...
-- GetAllComputersByGroup
IF EXISTS (SELECT [ID] FROM dbo.sysobjects WHERE [ID] = OBJECT_ID(N'[dbo].[GetAllComputersByGroup]')
					   AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[GetAllComputersByGroup]
GO
