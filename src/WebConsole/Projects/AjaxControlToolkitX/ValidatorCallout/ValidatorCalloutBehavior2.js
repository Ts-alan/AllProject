...
AjaxControlToolkit.ValidatorCalloutBehavior2 = function AjaxControlToolkit$ValidatorCalloutBehavior2(element) {
    AjaxControlToolkit.ValidatorCalloutBehavior2.initializeBase(this, [element]);
...
AjaxControlToolkit.ValidatorCalloutBehavior2.prototype = {
    initialize: function () {
        AjaxControlToolkit.ValidatorCalloutBehavior2.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        ...
        AjaxControlToolkit.ValidatorCalloutBehavior2.callBaseMethod(this, 'dispose');
    },
    ...
    show: function (force) {
        ...
        if (force || !this.get_isOpen()) {
            ...
            if (AjaxControlToolkit.ValidatorCalloutBehavior2._currentCallout != null) {
                return;
            }
            AjaxControlToolkit.ValidatorCalloutBehavior2._currentCallout = this;
    ...
    hide: function () {
        if (AjaxControlToolkit.ValidatorCalloutBehavior2._currentCallout == this) {
            AjaxControlToolkit.ValidatorCalloutBehavior2._currentCallout = null;
        }
        if (this.get_isOpen()) {
...
AjaxControlToolkit.ValidatorCalloutBehavior2.registerClass('AjaxControlToolkit.ValidatorCalloutBehavior2', AjaxControlToolkit.BehaviorBase);
