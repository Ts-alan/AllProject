...
using Vba32.ControlCenter.PeriodicalMaintenanceService.TaskAssignment.Tasks;
...
namespace Vba32.ControlCenter.PeriodicalMaintenanceService.TaskAssignment
{
    ...
    public class Vba32ControlCenterWrapper
    {
        ...
        public Int32 DefaultConfigureAgent(String ip)
        {
            ...
            //Format path in "C:\Program Files\Vba32 Control Center\Vba32PMS.exe"
            ...
            return PacketCustomAction(new Int64[] { 0 }, new String[] { ip }, xml);
        }
