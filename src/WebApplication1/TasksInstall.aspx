<%@ Page Language="C#" EnableEventValidation="false" validateRequest="false" MasterPageFile="~/mstrPageMain.master" AutoEventWireup="true" Inherits="TasksInstall" Title="<%$ Resources:resource,AttachTasks %>" Codebehind="TasksInstall.aspx.cs" %>
