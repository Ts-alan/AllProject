...
public partial class ControlCenter : PageBase
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            (e.Row.Cells[0].FindControl("ibtnSend") as ImageButton).ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/" + (ent.Send ? "enabled.gif" : "disabled.gif");
            (e.Row.Cells[1].FindControl("ibtnNoDelete") as ImageButton).ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/" + (ent.NoDelete ? "enabled.gif" : "disabled.gif");
        }
    }
