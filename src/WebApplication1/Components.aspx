<%@ Page Language="C#" MasterPageFile="~/mstrPageNew.master" AutoEventWireup="true" Inherits="Components" Title="<%$ Resources:resource,PageComponentsTitle %>" Codebehind="Components.aspx.cs" %>
