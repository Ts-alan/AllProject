...
/// <summary>
/// Задача для получения состояния компонентов
/// </summary>
public partial class Controls_TaskComponentState : System.Web.UI.UserControl, ITask
{
    ...
    public TaskUserEntity GetCurrentState()
    {
        ...
        xml.AddNode("Type", "ComponentState");
        xml.Generate();
    ...
    {
        if (task.Type != TaskType.ComponentState)
