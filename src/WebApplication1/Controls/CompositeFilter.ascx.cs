...
public partial class Controls_CompositeFilter : System.Web.UI.UserControl, ICompositeFilter
{
        ...
        get
        {
            if (UserFiltersTemproraryStorage.Storage == null)
            {
                UserFiltersTemproraryStorage.Storage =
                    CompositeFilterStateCollection.Deserialize(ProfileCommon.CurrentUser.GetPropertyValue(userFiltersProfileKey) as string);
            }
    ...
    {
        ProfileCommon.CurrentUser.SetPropertyValue(userFiltersProfileKey, UserFilters.Serialize());
    }
