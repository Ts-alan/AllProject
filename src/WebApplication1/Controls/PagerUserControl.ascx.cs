...
public partial class Controls_PagerUserControl : System.Web.UI.UserControl
{
    ...
    {
        FirstImageUrl = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/page-first.gif";
        PreviousImageUrl = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/page-prev.gif";
        NextImageUrl = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/page-next.gif";
        LastImageUrl = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/page-last.gif";
        FirstImageUrlDisabled = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/page-first-disabled.gif";
        PreviousImageUrlDisabled = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/page-prev-disabled.gif";
        NextImageUrlDisabled = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/page-next-disabled.gif";
        LastImageUrlDisabled = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/page-last-disabled.gif";
    }
