...
public partial class Controls_CollapsiblePanelSwitch : System.Web.UI.UserControl
{
    ...
    private void SetPanelVisible()
    {
        ...
        if (visible)
        {
            ...
            imbtnSwitch.ImageUrl = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/arrow_up.gif";
        }
        else
        {
            ...
            imbtnSwitch.ImageUrl = "~/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/arrow_down.gif";
        }
    }
    ...
    private void SetButtonOnclick()
    {
        imbtnSwitch.Attributes.Add("onclick", String.Format("CollapsiblePanel.Toggle('{0}', '{1}', '{2}', '{3}'); return false;",
            collapsiblePanel.ClientID, imbtnSwitch.ClientID, hfSwitch.ClientID, ProfileCommon.CurrentUser.Theme));
    }
    #endregion
}