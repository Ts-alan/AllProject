...
public partial class CompInfo : PageBase
{
    ...
    private void WriteCompInfo(String computerName)
    {
        ...
        if (isControlCenter)
            imgControlCenter.ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/enabled.gif";
        else
            imgControlCenter.ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/disabled.gif";
        ...
        if (comp.Vba32Integrity)
            imgVBA32Integrity.ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/enabled.gif";
        else
            imgVBA32Integrity.ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/disabled.gif";

        if (comp.Vba32KeyValid)
            imgKeyValid.ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/enabled.gif";
        else
            imgKeyValid.ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/disabled.gif";
        //}
        //else
        //{
    ...
    private String GetImageSrcByState(String state, out String title)
    {
        ...
        {
            case "On":
                return "App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/SwitchOn.png";
            case "Off":
                return "App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/SwitchOff.png";
            case "Not installed":
                return "App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/disabled.gif";
        }
