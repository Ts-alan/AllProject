<%@ Page Language="C#" MasterPageFile="~/mstrPageMain.master" EnableEventValidation="false" validateRequest="false" AutoEventWireup="true" Inherits="TaskCreate" Codebehind="TaskCreate.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMainContainer" Runat="Server">
    ...
    <table>
        <tr>
            ...
            <td>
                &nbsp;&nbsp;
                <asp:TextBox ID="tbSaveAs" runat="server"></asp:TextBox>
                &nbsp;&nbsp;
                <asp:LinkButton ID="lbtnSaveAs" runat="server" OnClick="lbtnSaveAs_Click"></asp:LinkButton>
            </td>
        </tr>
    </table>
    ...
    <asp:Panel ID="pnlModalPopapMessage" runat="server" Style="display: none" CssClass="modalPopupMessage">
        <div runat="server" id ="mpPicture" class="ModalPopupPictureSuccess"></div>
