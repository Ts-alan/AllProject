<%@ Page Language="C#" MaintainScrollPositionOnPostback="true"  validateRequest="false" MasterPageFile="~/mstrPageMain.master" AutoEventWireup="true" Inherits="Groups" Title="Untitled Page" EnableEventValidation="false" Codebehind="Groups.aspx.cs" %>
...
<%@ Register Src="~/Controls/TaskProgramAndDataBaseUpdate.ascx" TagName="TaskUser"  TagPrefix="tskProgramAndDataBaseUpdate"%>
            ...
            <tr>
                <td>
                    <asp:Panel ID="pnlTask" runat="server" style="width:100%">
                          ...
                          <tskProgramAndDataBaseUpdate:TaskUser ID="tskProgramAndDataBaseUpdate" runat="server" Visible="false"  />
                    </asp:Panel>
                </td>
            </tr>
        </table>
    ...
    <table width="100%" class="subWebParts">
        <tr>
            ...
            <td align="center" style="width:33%">
				<%= Resources.Resource.PageSize %>&nbsp;
                <asp:dropdownlist id="ddlPageSize" runat="server" Width="96px" AutoPostBack="True" OnSelectedIndexChanged="ddlPageSize_SelectedIndexChanged" style="width:60px">
				</asp:dropdownlist>
			</td>
			<td align="right" style="width:33%">
			    <%= Resources.Resource.Design %>&nbsp;
                <asp:DropDownList ID="ddlWebPartState" runat="server" style="width:100px" AutoPostBack="True" OnSelectedIndexChanged="ddlWebPartState_SelectedIndexChanged">
                </asp:DropDownList>
			</td>
        </tr>
    </table>    
