...
public partial class Groups : PageBase
{
    ...
    private void InitializeSession()
    {
        ...
        if (Session["GroupFilters"] == null)
            Session["GroupFilters"] = new GroupFilterCollection(ProfileCommon.CurrentUser.GroupFilters);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        GroupFilterCollection collection = new GroupFilterCollection(ProfileCommon.CurrentUser.GroupFilters);
