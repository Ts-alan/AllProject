...
public partial class _Default : PageBase
{
    ...
    protected override void InitFields()
    {
        ...
        else
        {
            try
            {
                MembershipUser user = Membership.GetUser(ProfileCommon.CurrentUser.UserName == String.Empty ? "Admin" : ProfileCommon.CurrentUser.UserName);
    ...
    private void FillServicesTable()
    {
        ...
        while (enumerator.MoveNext())
        {
            ...
            Image img = new Image();
            img.ImageUrl = Request.ApplicationPath + "/App_Themes/" + ProfileCommon.CurrentUser.Theme + "/Images/" + strBool;
